...
export function BroadcastControls({ streamId, status }: { streamId: string; status: string }) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <p className="text-xs text-muted-foreground">
        This is your local broadcaster preview. In production this feed connects to LiveKit for
        real-time distribution to viewers — see the architecture doc for the integration point.
      </p>
      <div className="flex flex-wrap items-center gap-2">
        ...
        {status !== "LIVE" ? (
          ...
          <Button variant="destructive" size="sm" onClick={endStream} disabled={loading} className="gap-1.5">
